...
public class TaxTier3 extends Payslip {
	
	
	public TaxTier3(String first, String last, int salary, double superAnnuation, String date) {
		super(first, last, salary, superAnnuation, date);
		super.setUpperLimit(Integer.valueOf(myResources.getString("tier.3.upperLimit")));
		super.setLowerLimit(Integer.valueOf(myResources.getString("tier.3.lowerLimit")));
		super.setTaxPerDollar(Double.valueOf(myResources.getString("tier.3.tax.dollar")));
		super.setTaxBase(Integer.valueOf(myResources.getString("tier.3.base")));
	}
