...
public class TaxTier4 extends Payslip {
	
	
	public TaxTier4(String first, String last, int salary, double superAnnuation, String date) {
		super(first, last, salary, superAnnuation, date);
		super.setUpperLimit(Integer.valueOf(myResources.getString("tier.4.upperLimit")));
		super.setLowerLimit(Integer.valueOf(myResources.getString("tier.4.lowerLimit")));
		super.setTaxPerDollar(Double.valueOf(myResources.getString("tier.4.tax.dollar")));
		super.setTaxBase(Integer.valueOf(myResources.getString("tier.4.base")));
	}
